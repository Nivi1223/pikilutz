...
const Piklotz = () => {
  ...
  const letterNew = `אני אתחיל את הפקלוץ ואגיד שהרגע שבו שמעתי שאת איתנו בסגל קפצתי על נגה משמחה כי וואלה באמת רציתי לעבוד איתך, יש לזה המון סיבות אבל אני אתן את הטאצ' האישי שלי. דבר ראשון - את אור. את נקודת אור קטנה וקופצנית שפשוט יודעת תמיד לעשות שמח סביבה ולהרים את האנשים גם שהם עצובים, אני באמת חושב שעשית אותי הרבה יותר שמח בחצי השני של הסגל.
